def pytest_addoption(parser):
    ...
    parser.addoption('--user', action='store', dest='username', type=str, default='Ftest', help='Username')
    parser.addoption('--password', action='store', dest='password', type=str, default='C2XxwErz41', help='Password')
